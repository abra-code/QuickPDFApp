...
# on a real user selection, so the live table value is current here. The whole
# list places the Up and Down buttons.
apply_file_selection "$OMC_ACTIONUI_TABLE_10_COLUMN_2_VALUE" "$OMC_ACTIONUI_TABLE_10_COLUMN_2_ALL_ROWS"
